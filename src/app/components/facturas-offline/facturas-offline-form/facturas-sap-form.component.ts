...
@Component({
  ...
  templateUrl: "./facturas-sap-form.component.html",
  styleUrls: ["./facturas-sap-form.component.css"],
})
export class FacturasSapFormComponent implements OnInit {
  UsuarioActual: any;
  ...
  constructor(
    public facturasofflineService: FacturasOfflineService,
    private notificationService: NotificationService,
    public dialogRef: MatDialogRef<FacturasSapFormComponent>,
  ...
  onSaveFacturas() {
    if (!this.facturasofflineService.form.get("cuf").value) {
      this.facturasofflineService
        .submitFacturas(this.facturasofflineService.form.value)
        .subscribe(
          (data) => {
            this.dialogRef.close({ event: this.action, data: data });
            this.notificationService.success("EXITOSO");
            this.facturasofflineService.form.reset();
          },
          (error) => {
      ...
      if (this.action == "Anular") {
        this.facturasofflineService
          .updateFacturas(this.facturasofflineService.form.value)
          .subscribe((data) => {
            this.dialogRef.close({ event: this.action, data: data });
            this.facturasofflineService.form.reset();
            this.facturasofflineService.initializeFormGroup();
      ...
      if (this.action == "Eliminar") {
        this.facturasofflineService
          .deletedFacturas(this.facturasofflineService.form.value.id)
          .subscribe((data) => {
            this.dialogRef.close({ event: this.action, data: data });
            this.facturasofflineService.form.reset();
            this.facturasofflineService.initializeFormGroup();
