...
export class PdvService {
  ...
  sife_pdv_get_activos(nit) {
    const url_api =
      ...
      ":" +
      glob.port +
      '/api/sife_pdv?filter={"where":{"estado":"Cuis Activo","nit":"' + nit + '"},"order":["fechaCreacion DESC"]}';
    return this.http.get<any[]>(url_api).toPromise();
  }
  sife_pdv_get_all(nit, sucursal) {
    ...
    const url_api =
      ...
      ":" +
      glob.port +
      '/api/sife_pdv?filter={"where":{"estado":"Cuis Activo","nit":"' + nit + '", "codigoSucursal":"'+sucursal+'"},"order":["fechaCreacion ASC"]}';
    return this.http.get<any[]>(url_api).toPromise();
  }
  sife_pdv_post(pdv) {
